...
Developing and maintaining scalable web applications with modern technologies.

Working with MERN stack to build user-centric applications with optimized performance.
...
**Manasvi Technologies OPC Pvt. Ltd., Bhopal, India** *(June 2023 - February 2025)*  
- 🚀 **Key Contributions**:
...
<ul>
  <li>📧 Email: <a href="dheerendra@hola9.com">dheerendra@hola9.com</a></li>
